...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 60, 301, 81))
        ...
        self.btnRun.setGeometry(QtCore.QRect(170, 380, 141, 31))
        self.btnRun.setIconSize(QtCore.QSize(24, 32))
        self.btnRun.setObjectName("btnRun")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(10, 470, 301, 131))
        font = QtGui.QFont()
        font.setBold(True)
        self.groupBox.setFont(font)
        self.groupBox.setObjectName("groupBox")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.groupBox)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(9, 19, 281, 104))
        ...
        self.btnGenSaveTurbo = QtWidgets.QPushButton(self.horizontalLayoutWidget_2)
        font = QtGui.QFont()
        font.setBold(False)
        self.btnGenSaveTurbo.setFont(font)
        self.btnGenSaveTurbo.setObjectName("btnGenSaveTurbo")
        self.verticalLayout_7.addWidget(self.btnGenSaveTurbo)
        self.horizontalLayout_4.addLayout(self.verticalLayout_7)
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 140, 301, 141))
        ...
        self.btnLog.setGeometry(QtCore.QRect(10, 380, 81, 31))
        self.btnLog.setObjectName("btnLog")
        self.btnErr = QtWidgets.QPushButton(self.centralwidget)
        self.btnErr.setGeometry(QtCore.QRect(90, 380, 81, 31))
        self.btnErr.setObjectName("btnErr")
        self.groupBox_4 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_4.setGeometry(QtCore.QRect(10, 410, 301, 61))
        self.groupBox_4.setObjectName("groupBox_4")
        self.btnTurbo = QtWidgets.QPushButton(self.groupBox_4)
        self.btnTurbo.setGeometry(QtCore.QRect(160, 10, 141, 41))
        ...
        self.lblBanner.setGeometry(QtCore.QRect(10, 0, 301, 61))
        self.lblBanner.setObjectName("lblBanner")
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(10, 630, 301, 26))
        self.horizontalLayoutWidget_3.setObjectName("horizontalLayoutWidget_3")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_3)
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.btnPause = QtWidgets.QPushButton(self.horizontalLayoutWidget_3)
        self.btnPause.setObjectName("btnPause")
        self.horizontalLayout_5.addWidget(self.btnPause)
        self.btnStop = QtWidgets.QPushButton(self.horizontalLayoutWidget_3)
        self.btnStop.setObjectName("btnStop")
        self.horizontalLayout_5.addWidget(self.btnStop)
        self.layoutWidget1 = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 600, 301, 27))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(10, 280, 301, 101))
        font = QtGui.QFont()
        font.setBold(False)
        self.groupBox_3.setFont(font)
        self.groupBox_3.setObjectName("groupBox_3")
        self.layoutWidget2 = QtWidgets.QWidget(self.groupBox_3)
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 20, 148, 84))
        self.layoutWidget2.setObjectName("layoutWidget2")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.layoutWidget2)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.chMerge = QtWidgets.QCheckBox(self.layoutWidget2)
        ...
        self.chError = QtWidgets.QCheckBox(self.layoutWidget2)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(160, 20, 148, 81))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.chBg = QtWidgets.QCheckBox(self.verticalLayoutWidget_2)
        self.chBg.setObjectName("chBg")
        self.verticalLayout_6.addWidget(self.chBg)
        self.chImg = QtWidgets.QCheckBox(self.verticalLayoutWidget_2)
        self.chImg.setChecked(True)
        self.chImg.setObjectName("chImg")
        self.verticalLayout_6.addWidget(self.chImg)
...
"Pobierz z zakresu"))
        ...
        self.groupBox_5.setTitle(_translate("MainWindow", "Format plików"))
        self.chPDF.setText(_translate("MainWindow", "PDF"))
